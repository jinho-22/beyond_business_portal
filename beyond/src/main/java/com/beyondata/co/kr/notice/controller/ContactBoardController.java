package com.beyondata.co.kr.notice.controller;
...
import com.beyondata.co.kr.admin.member.controller.AdminController;
import com.beyondata.co.kr.member.vo.MemberVO;
import com.beyondata.co.kr.notice.service.BoardService;
import com.beyondata.co.kr.notice.service.BoardServiceImpl;
...
public class ContactBoardController {
    ...
    public String sendInquiryEmail(@RequestParam("type") String type,
        ...
        try {
            // 이메일 발송
            boardService.sendEmail("jh.woo@beyondata.co.kr", "고객 문의 - " + subject, mailContent);
