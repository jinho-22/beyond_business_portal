                        ...
                        <div class="form-box">
                          ...
                          <div class="checkset-wrap">
                            <div class="checkset checkset-fill">
                              <c:choose>
                                <c:when test="${not empty loggedInUser && loggedInUser.role == 'beyondata'}">
                                  <input id="beyondata" name="role" class="checkset-input" type="radio" value="beyondata"
                                    checked />
                                </c:when>
                                <c:otherwise>
                                  <input id="beyondata" name="role" class="checkset-input" type="radio" value="beyondata" />
                              ...
                              <label for="beyondata" class="checkset-label">비욘드데이터</label>
                            </div>
                            <div class="checkset checkset-fill">
                              <c:choose>
