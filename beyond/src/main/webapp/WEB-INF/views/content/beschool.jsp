            ...
            <body>
                <main class="th-layout-main">
                    ...
                    <div class="th-layout-content">
                            ...
                            <div class="contents-container container-md">
                                <div class="contents-inner">
                                    <figure class="cardset-figure">
                                        <img class="cardset-img" src="/images/content/beschool_logo.png"
                                            alt="스와이퍼 이미지" />
                                    </figure>
                                    <div class="textset">
                        ...
                        <div class="content-N32" id="jKM6OIDXAf">
                            <div class="contents-container container-md">
                                <div class="contents-inner">
                                    <div class="imageset">
                                        <img class="imageset-img" src="/images/content/beschool.png" alt="이미지" />
                                    </div>
                                    <div class="textset">
                        ...
                        <div class="content-N14" id="oum6Ogweyt">
                            <div class="contents-container container-md">
                                <div class="contents-inner">
                                    <div class="textset">
