            ...
            <body>
                <main class="th-layout-main">
                    ...
                    <div class="th-layout-content">
                            ...
                            <div class="contents-container container-md">
                                <div class="contents-inner">
                                    <figure class="cardset-figure">
                                        <img class="cardset-img" src="/images/content/begreen_logo.png"
                                            alt="스와이퍼 이미지" />
                                    </figure>
                                    <div class="textset">
                        ...
                        <div class="content-N32" id="JuM6oIvVHI">
                            <div class="contents-container container-md">
                                <div class="contents-inner">
                                    <div class="imageset">
                                        <img class="imageset-img" src="/images/content/begreen.jpg" alt="이미지" />
                                    </div>
                                    <div class="textset">
                        ...
                        <div class="content-N14" id="BXm6ojOFbX">
                            <div class="contents-container container-md">
                                <div class="contents-inner">
                                    <div class="textset">
