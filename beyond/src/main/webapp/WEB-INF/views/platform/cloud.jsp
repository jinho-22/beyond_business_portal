                            ...
                            <div class="platform-inner">
                                <div class="cloud-N46" id="RCM6k3y4v3">
                                    <div class="contents-container container-md">
                                        <div class="contents-inner">
                                            <div class="textset">
                                                <h2 class="textset-tit h3">비욘드데이터는 고객의 클라우드 사용을 위해 <br />최적화된 기술역량 및 운영체계를
                                                    보유하고
                                                    있습니다.</h2>
                                            </div>
                                        ...
                                        <div class="contents-container container-md">
                                            <div class="contents-container container-md">
                                                <div class="contents-inner">
                                                    ...
                                                    <p class="p1 textset-desc">비욘드데이터는 KT Cloud, Naver Cloud Platform, NHN
                                                        Cloud 등
                                                    ...
                                                    <div class="col">
                                                        <div class="cardset cardset-hover cardset-border">
                                                            ...
                                                            <div class="cardset-cont">
                                                                ...
                                                                <p class="p1 cardset-desc" style="text-align: center;">
                                                                    비욘드데이터는 사업영역 확장에 따라 국내외 다양한 CSP와의
                                                                    파트너십을 준비중이며, 클라우드
                                                                    시장 선도를 위해 노력중입니다.
                                                                </p>
                                                            </div>
                                            ...
                                            <div class="contents-inner">
                                                <div class="textset">
                                                    <h3 class="textset-tit h3" style="text-align: center;">고객의 스마트한 클라우드
                                                        이용을 위한
                                                        기술 지원 역량</h3>
                                                    <div class="textset-tit p1" style="text-align: center;">비욘드데이터는 다양한
                                                        오픈소스/상용
                                                        DBMS, WEB, WAS 기술력을
                                                        보유하여<br />고객의
                                ...
                                <div class="cloud-N74" id="ykM6K55Bh9">
                                    ...
                                    <div class="cloud-N31" id="Oqm6K5DqCP">
                                        <div class="contents-container container-md">
                                            ...
                                            <div class="cardset cardset-hover cardset-border">
                                                <div class="cardset-cont">
                                                    <h3 class="textset-tit h3" style="text-align: center;">비욘드데이터 컨설팅 서비스
                                                        이용으로
                                            ...
                                            <div class="cardset cardset-hover cardset-border">
                                                <div class="cardset-cont">
                                                    <h3 class="textset-tit h3" style="text-align: center;"> 비욘드데이터 마이그레이션
                                                        서비스
                                                        이용으로
                                                ...
                                                <div class="row row-cols-3 row-md-cols-2 row-sm-cols-1 tableset">
                                                    ...
                                                    <div class="col cardset">
                                                        ...
                                                        <div class="cardset-body">
                                                            ...
                                                            <p class="p1 cardset-desc">Beyondata ICC를 통한 안정적인 운영관리<br />고객
                                                                시스템 인프라를
                                                                클라우드 전문 인력이 대신 운영</p>
                                                        </div>
                                                    </div>
                            ...
                            <div class="platform-inner">
                                <div class="cloud-N74" id="EJM6k4ylEY">
                                    ...
                                    <div class="cloud-N57">
                                        <div class="contents-container container-md">
                                            <div class="textset">
                                                <h2 class="textset-tit h3">Beyondata ICC(Interactive Contact Center)</h2>
