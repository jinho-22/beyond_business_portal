...
(function() {
  $(function() {
    $(".content-N42[id=\'bMM6ojerkN\']").each(function() {
      const $block = $(this);
      // Swiper
      const swiper = new Swiper(".content-N42[id=\'bMM6ojerkN\'] .contents-swiper", {
        slidesPerView: 'auto',
        spaceBetween: 0,
        loop: true,
        autoplay: {
        ...
        navigation: {
          nextEl: ".content-N42[id=\'bMM6ojerkN\'] .swiper-button-next",
          prevEl: ".content-N42[id=\'bMM6ojerkN\'] .swiper-button-prev",
        },
        pagination: {
          type: "progressbar",
          el: ".content-N42[id=\'bMM6ojerkN\'] .swiper-pagination",
          clickable: true,
        },
      });
    });
...
(function() {
  $(function() {
    $(".dataservice-N42[id=\'bMM6ojerkN\']").each(function() {
      const $block = $(this);
      // Swiper
      const swiper = new Swiper(".dataservice-N42[id=\'bMM6ojerkN\'] .contents-swiper", {
        slidesPerView: 'auto',
        spaceBetween: 0,
        loop: true,
        autoplay: {
        ...
        navigation: {
          nextEl: ".dataservice-N42[id=\'bMM6ojerkN\'] .swiper-button-next",
          prevEl: ".dataservice-N42[id=\'bMM6ojerkN\'] .swiper-button-prev",
        },
        pagination: {
          type: "progressbar",
          el: ".dataservice-N42[id=\'bMM6ojerkN\'] .swiper-pagination",
          clickable: true,
        },
      });
    });
